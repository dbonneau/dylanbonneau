...
@Component({
  selector: 'app-article2023070201',
  imports: [],
  templateUrl: './article2023070201.component.html',
  styleUrl: './article2023070201.component.scss'
})
export class Article2023070201Component {
