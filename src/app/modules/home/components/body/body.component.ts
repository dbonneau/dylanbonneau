...
export class BodyComponent {
    ...
    public testimonials = [{
        ...
        texts: [`Dylan nous a accompagnés de A à Z dans la préparation de la journée du mariage. Le jour J, il
        s'est
        ...
        matinée.`, `Merci infiniment Dylan pour tout, les clichés sont absolument sublimes et reflètent vraiment notre
        ...
        incroyable !`, `Foncez les yeux fermés. Merci, du fond du cœur !`]
    },
    {
        imgUrl: 'https://i.goopics.net/9bvm0e.jpg',
